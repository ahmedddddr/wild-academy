  ...
  return (
    <div className="home">
      ...
      <nav className="bottom-toolbar">
        <a href="#home" className="toolbar-item">
          <span className="toolbar-icon">🏠</span>
          <span className="toolbar-label">Home</span>
        </a>
        <a href="#locations" className="toolbar-item">
          <span className="toolbar-icon">📍</span>
          <span className="toolbar-label">Locations</span>
        </a>
        <a href="#activities" className="toolbar-item">
          <span className="toolbar-icon">🎮</span>
          <span className="toolbar-label">Activities</span>
        </a>
        <a href="#about" className="toolbar-item">
